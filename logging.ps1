...
$YourModsToLog = "QuestHook[`|v]:* QuestHook[streamer-tools`|v0.1.0]:* QuestHook[QuestSounds`|v0.3.0]:* QuestHook[QuestSounds`|v1.0.0]:* QuestHook[ServerBrowser`|v0.1.0]:*"
...
adb logcat -T "$timestamp" main-modloader:W AndroidRuntime:E *:S $YourModsToLog $OtherModsToLog $LibsToLogError
        ...
        if ($args[0] -eq "--file") {
            ...
            $logger = Start-Job -Arg "$timestamp", $PSScriptRoot -scriptblock {
                ...
                adb logcat -v color -T "$timestamp" main-modloader:W libmodloader:W libmain:W AndroidRuntime:E QuestHook[`|v]:* QuestHook[UtilsLogger`|v2.0.3]:W QuestHook[BeatTogether`|v1.2.5]:* QuestHook[ServerBrowser`|v0.1.0]:* *:S | Tee-Object -FilePath "$Path/logcat.log"
            }
