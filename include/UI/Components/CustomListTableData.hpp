...
namespace ServerBrowser::UI::Components {
    //extern CustomListTableData* CreateScrollableCustomListTableData(UnityEngine::Transform* parent, std::function<void(int)> onCellWithIdxClicked, std::function<void()> onPageUpButtonClick, std::function<void()> onPageDownButtonClick);
    //extern CustomListTableData* CreateScrollableCustomListTableData(UnityEngine::Transform* parent, UnityEngine::Vector2 sizeDelta, std::function<void(int)> onCellWithIdxClicked, std::function<void()> onPageUpButtonClick, std::function<void()> onPageDownButtonClick);
    //extern CustomListTableData* CreateScrollableCustomListTableData(UnityEngine::Transform* parent, UnityEngine::Vector2 anchoredPosition, UnityEngine::Vector2 sizeDelta, std::function<void(int)> onCellWithIdxClicked, std::function<void()> onPageUpButtonClick, std::function<void()> onPageDownButtonClick);
    extern CustomListTableData* CreateGameList(UnityEngine::Transform* parent, UnityEngine::Vector2 anchoredPosition, UnityEngine::Vector2 sizeDelta, std::function<void(int)> onCellWithIdxClicked);
}