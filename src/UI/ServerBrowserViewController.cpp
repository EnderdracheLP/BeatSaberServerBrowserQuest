...
#pragma endregion
            ...
            statusLayout->get_gameObject()->AddComponent<Backgroundable*>()->ApplyBackground("round-rect-panel");
    ...
    void ServerBrowserViewController::DidDeactivate(bool removedFromHierarchy, bool systemScreenDisabling) {
        ...
        ServerBrowser::Game::MpModeSelection::SetTitle(Polyglot::Localization::Get("LABEL_MULTIPLAYER_MODE_SELECTION"));
